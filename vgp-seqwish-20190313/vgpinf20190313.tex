...
\title[\textsc{seqwish} @ VGP informatics]{Seqwish cichlid evaluation} % The short title appears at the bottom of every slide, the full title is only on the title page
